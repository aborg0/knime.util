 ...
 */
public class PreprocessorNodePlugin extends Plugin {
    // The shared instance.
    private static PreprocessorNodePlugin plugin;

    /**
     * The constructor.
     */
    public PreprocessorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PreprocessorNodePlugin getDefault() {
        return plugin;
    }
